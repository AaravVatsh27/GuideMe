...
export const INDIAN_CITIES_BY_STATE = {
  ...
  Telangana: ["Hyderabad", "Warangal", "Khammam", "Karimnagar", "Nizamabad", "Nalgonda"],
  Tripura: ["Agartala", "Udaipur", "Dharmanagar", "Kailashahar"],
  "Uttar Pradesh": ["Lucknow", "Noida", "Ghaziabad", "Kanpur", "Varanasi", "Prayagraj", "Agra", "Meerut", "Gorakhpur"],
...
} as const satisfies Record<IndianStateValue, readonly string[]>;

export const INDIAN_CITY_VALUES = Array.from(
  new Set(Object.values(INDIAN_CITIES_BY_STATE).flat()),
).sort((left, right) => left.localeCompare(right));

export const MAJOR_INDIAN_CITIES = INDIAN_CITY_VALUES;

export function getIndianCitiesForState(state?: IndianStateValue) {
  if (!state) {
    return INDIAN_CITY_VALUES;
  }
